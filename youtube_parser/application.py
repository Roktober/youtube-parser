...
from youtube_parser.loader import YoutubeLoader, SearchParamBuilder, SearchOrder, SearchType, SearchVideoDuration
...
class Application:
    ...
    async def run(self):
        ...
        params = SearchParamBuilder(api_key=self._config.youtube_parser.api_key). \
            q('lofi hip-hop'). \
